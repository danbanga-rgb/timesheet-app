...
| **Arc state** | Main `ca1ab0a`. TS.tsx 15,871 → 13,048 (−2,823, −17.8%). Test suite: 491 passing / 6 pre-existing fails unchanged. | 🟢 in progress | S4 EOD | Next: I5 (optional InvoiceReconBadge, ~45min) or straight to I6 (Invoices tab extract, ~3h). Then X5/X6/CB, IB, then 🛑 STOP GATE (QB Automation talk with Dan) before X4/QA7/QA8/QA9. |
