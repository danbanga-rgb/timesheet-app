...
| **Arc state** | Main `3b57336`. TS.tsx 15,871 → 10,995 (−4,876, −30.7%). Test suite: 516 passing / 6 pre-existing fails unchanged. Invoice cluster CLOSED (I1/I2/I3/I6; I5 skipped). IIF DELETED (X7). InvoiceDetailModal EXTRACTED (I7). | 🟢 in progress | S6 EOD | Next: X5+X6 (Convera batch file tests + extract, ~5–6h, preps CB), then CB, then IB, then 🛑 STOP GATE (QB Automation talk with Dan) before X4/QA7/QA8/QA9. QE/PI deps on X7 IIF need re-scope. |
